...
/**
 * Service to manage the parking system operations such as processing incoming and exiting vehicles.
 */
public class ParkingService {
     ...
     * 
     * @param inputReaderUtil utility to read user input
     * @param parkingSpotDAO data access object for parking spots
     * @param ticketDAO data access object for tickets
     */
    ...
    /**
     * Processes the incoming vehicle by assigning a parking spot and generating a ticket.
     */
    ...
    /**
     * Gets the next available parking spot if available.
     * 
    ...
    /**
     * Processes the exiting vehicle by calculating the fare and updating the ticket.
     */
    public void processExitingVehicle() {
        try {
            ...
            if (isNotFirstPassage) {
                ...
                fareCalculatorService.calculateFare(ticket); // If it's the first passage, no discount
            }
